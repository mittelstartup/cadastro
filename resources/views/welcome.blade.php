    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title" style="text-align: center ">Política de privacidade para Mittel Estagios</h2>
            </div>
            <div class="modal-body">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <li><p style="text-align: justify"> Para mover utilize o botão scroll do mouse, ou as setas direcionais do teclado</p></li>
                <li><p style="text-align: justify"> Para fechar utilize o botão no final da página, ou pressione a tecla "Esc" do teclado</p></li>
                <h2>VISÃO GERAL</h2>
